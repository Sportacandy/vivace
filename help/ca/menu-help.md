...
- **Continguts** (`F1`) — obrir aquesta finestra d'ajuda. La llista de l'esquerra
  és la taula de continguts; feu clic a un tema per llegir-lo a la dreta. Els
  enllaços dins d'una pàgina obren el tema relacionat aquí; els enllaços externs
...
SMPlayer, publicat sota la llicència **GPL-3.0-or-later**.
