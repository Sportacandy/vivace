...
<context>
    ...
    <message>
        ...
        <translation>在 Vivace 內部開啟登入頁面，並將產生的工作階段儲存為上方的 Cookie 檔案——這是 Android 版對應於從桌面瀏覽器匯出 cookies.txt 的方式，不需要另外匯出／傳輸步驟。使用你想使用的 YouTube 帳號登入，然後點選「儲存 Cookie」，再點選「關閉」。</translation>
    </message>
    <message>
